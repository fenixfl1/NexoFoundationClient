...
export const API_GET_STAFF_PAGINATION = '/user/pagination'
...
export const API_PATH_GET_STUDENT = '/students/'
...
export const API_PATH_GET_REPORT_CATALOG = '/reports/catalog'
export const API_PATH_RUN_REPORT = '/reports/run'
export const API_PATH_EXPORT_REPORT = '/reports/export'
...
export const API_PATH_GET_DISBURSEMENT_PAGINATION = '/disbursements/pagination'
